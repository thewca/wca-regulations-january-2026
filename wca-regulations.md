...
- A4) Starting the solve:
    - A4b) The competitor uses their fingers to touch the elevated sensor surfaces of the Stackmat timer. The competitor's palms must be facing predominantly down, and located on the side of the timer that is closer to the competitor. Penalty: time penalty (+2 seconds).
