...
- A3) Inspection:
    ...
    - A3c) The competitor may pick up the puzzle during inspection.
        ...
        - A3c5) For Square-1, the competitor should not be penalized for any accidental move made within the limits of [Regulation 10f](regulations:regulation:10f). If the puzzle is in a state where a "/" move cannot be applied without a prior (X, Y) move, the competitor may perform a (X, Y) move to reach the closest state where a "/" move can be applied.
