...
- A7) Recording results:
    ...
    - A7g+++) [RECOMMENDATION] The WCA Delegate should use stronger discretion when granting more than one extra attempt to the same competitor, especially for the same type of incident. Example: if the WCA Delegate already awarded an extra attempt for a competitor who did not wait long enough for the green light, they should not typically award another extra attempt if that competitor fails to wait long enough for the green light again.
