...
- 9i) Results of official WCA competitions must be listed on the WCA world rankings.
    ...
    - 9i2) All the results of a round are considered to take place on the last calendar date of the round. If a regional record is broken multiple times on the same calendar date, only the best result is recognized as breaking that regional record. The calendar date is based on the local time at the competition location. For competitions with multiple physical locations (i.e. "3x3x3 Fewest Moves simultaneous competitions"), the calendar date is the latest date at any competition location.
