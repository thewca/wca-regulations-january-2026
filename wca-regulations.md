...
- 7f) Solving station:
    - 7f1) Definitions:
        ...
        - 7f1d) Surface: The flat surface on which the speedsolving timer has been placed. The mat is considered a part of the surface. The timer is not considered a part of the surface.
...
- A4) Starting the solve:
    ...
    - A4d) If a speedsolving timer is in use, the competitor should keep their hands on the timer until they see a green timer light. The timer is started when they remove their hand(s) from the timer. The competitor starts the solve by starting the timer.
...
- B2) Starting the attempt:
    ...
    - B2d) When using the speedsolving timer, the competitor should keep their hands on the timer until they see a green timer light. The timer is started when they remove their hand(s) from the timer. The competitor starts the attempt and the solve by starting the timer.
