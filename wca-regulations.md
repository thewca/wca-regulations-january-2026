...
- A6) Stopping the solve:
    ...
    - A6b) The competitor is responsible for stopping the Stackmat timer correctly.
        ...
        - A6b3) Competitors may use devices for automated inspection calls, at the descretion of the Delegate. At the beginning of the inspection, the judge must start the device, the competititor should not operate it during the attempt. (See [Regulation 2i](regulations:regulation:2i)) The device must sign only at 8 and 12 seconds and must not disturb other competitors.
